...
2. Write a program to display the first N natural numbers.
3. Write a program to find all odd numbers from 1 to N.
...
6. Write a program to find all even numbers from 1 to N.
7. Write a program to find all odd numbers from 1 to N.
...
10. Write a program to read 10 numbers from the keyboard and find their
sum and average.
