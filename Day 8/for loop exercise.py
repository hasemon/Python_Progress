...
# The names are in two lists, 'names' and 'names1' You also need to add
# two extra names to the list using an input box, when you run the code Printout one invitation to each friend per line
